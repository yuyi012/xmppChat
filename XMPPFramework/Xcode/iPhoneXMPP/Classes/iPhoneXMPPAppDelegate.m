...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  // Setup the XMPP stream
    ...
    MessageListController *chatController = [[MessageListController alloc]init];
    navigationController = [[UINavigationController alloc]initWithRootViewController:chatController];
	[window setRootViewController:navigationController];
	[window makeKeyAndVisible];
    [[NSUserDefaults standardUserDefaults]setObject:@"yuyi3@yuyi.local" forKey:kXMPPmyJID];
    [[NSUserDefaults standardUserDefaults]setObject:@"123" forKey:kXMPPmyPassword];
